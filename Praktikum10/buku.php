    ...
    if (isset($_POST['submit'])) {
        ...
        if ($pilihan == 'tambah') {
            if (tambah($conn, $_POST)) {
                header("Location: index.php?target=buku.php&status=sukses_tambah");
                exit;
            } else {
            ...
            if (!empty($_POST['id'])) {
                if (ubah($conn, $_POST)) {
                    header("Location: index.php?target=buku.php&status=sukses_ubah");
                    exit;
                } else {
        ...
        if (!empty($_POST['id'])) {
            if (hapus($conn, $_POST['id'])) {
                header("Location: index.php?target=buku.php&status=sukses_hapus");
                exit;
            } else {
    ...
    <div class="right-box">
        <form action="index.php" method="post">
            <div class="button-style">
                <button type="submit" name="target" value="buku.php" class="ganti activated">Buku</button>
        ...
        <form action="buku.php" method="post">
            <input type="hidden" name="target" value="buku.php">
